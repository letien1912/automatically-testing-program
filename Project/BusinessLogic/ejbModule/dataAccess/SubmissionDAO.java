...
/**
 * Session Bean implementation class SubmissionDAO
 */
@Stateless
@LocalBean
public class SubmissionDAO implements I_SubmissionDAORemote {
	...
	public void CreateSubmission(Submission submission) throws ExceptionHandeler {
		...
		try {
			...
			throw new ExceptionHandeler(e.getMessage(), 34, "SubmissionDAO", "Create Submission Fail");
		}
	...
	public void DeleteSubmission(Submission submisson) throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 48, "SubissionDAO", "Delete Submission Fail");
		}
	...
	public Submission GetSubmissionByID(String submissionID) throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 61,"SubmissionDAO", "Get Submission By ID fail");
		}
	}
	...
	public List<Submission> GetSubmissionByContestID(String contestID) throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 74, "SubmissionDAO", "Get Submission By ContestID fail");
		}
	}
	...
	public List<Submission> GetSubmissionByProblemID(String problemID) throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 87, "SubmissionDAO", "Get Submission By ProblemID fail");
		}
	}
	...
	public List<Submission> GetSubmissionByStudentID(String studentID) throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 100, "SubmissionDAO", "Get Submission By StudentID fail");
		}
	}

	@Override
	public List<Submission> GetSubmissionByStudent_ContestID(String studentID, String contestID)
			throws ExceptionHandeler {
		// TODO Auto-generated method stub
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 114, "SubmissionDAO", "Get Submission By StudentID and ContestID fail");
		}
	}
	...
	public List<Submission> GetSubmissionByStudent_ProblemID(String studentID, String problemID)
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 129, "SubmissionDAO", "Get Submission By StudentID and ProblemID fail");
		}
	}
	...
	public List<Submission> GetAllSubmission() throws ExceptionHandeler {
		...
		try {
			...
			// TODO: handle exception
			throw new ExceptionHandeler(e.getMessage(), 129, "SubmissionDAO", "Get All Submission fail");
		}
	}
